...
- **Google Sheets integration**: working. Service account auth connects, headers written, rows appended. Columns: Date Found, State, City, Business Name, Asking Price, SDE, URL, Industry.
- **Filtering logic**: working. SDE >= $300k included; no SDE but asking >= $1M included; everything else skipped.
